...
export const shiftPointer = (pointer) => {
  return ++pointer;
};
...
const openRoundBracket = (pointer, inputString) => {
  let obj = {
    result: undefined,
    err: "no_error",
...
const closeRoundBracket = (pointer, inputString) => {
  let obj = {
    result: undefined,
    err: "no_error",
...
const slash = (pointer, inputString) => {
  let obj = {
    result: undefined,
    err: "no_error",
    type: "slash",
...
const colon = (pointer, inputString) => {
  let obj = {
    result: undefined,
    err: "no_error",
    type: "colon",
